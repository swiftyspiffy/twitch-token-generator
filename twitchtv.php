...
class TwitchTV {
  ...
  var $client_id = 'CLIENTID'; //change this value, should be your TwitchTV Application Client ID
  var $client_secret = "CLIENTSECRET"; //change this value, should be your TwitchTV Application Client Secret 
  var $redirect_url = 'https://twitchtokengenerator.com'; //change this value, should be your TwitchTV Application Rerdirect URL
  var $scope_array = array('user_read', 'chat_login'); // placeholder data
	...
	function authenticated_user($access_token) {
		...
		if(isset($response['error'])) {
			...
			$username = $response['name']."|".$response['logo']."|".$response['email'];
			return $username;
		}
	}
